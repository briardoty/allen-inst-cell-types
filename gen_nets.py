...
def main(case, layer_name, n_repeat_arr, act_fns, act_fn_params, 
    ...
    if (case.startswith("control")):
        ...
        for n_repeat in n_repeat_arr:
            ...
            case_id = f"{case}_{layer_name}_nr-{n_repeat}"
            
            for i in range(n_samples):
                gen_net(manager, case_id, i, layer_name, n_repeat, act_fns, 
                        act_fn_params)
...
def gen_net(manager, case_id, i, layer_name, n_repeat, act_fns, act_fn_params):
    # init net
